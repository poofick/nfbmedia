	...
	<div class="desc">
		...
		<form method="post" action="<?php echo $this->build_url(array($this->controller, 'updateprofile')); ?>" enctype="multipart/form-data" class="mtop10">
			<table width="100%" cellpadding="3" cellspacing="3">
		        <tr><td colspan="2"><div class="error"><?php echo $this->error; ?></div></td></tr>
		        <tr>
		        ...
		        <tr>
		            <td><input type="submit" name="save" value="Зберегти" class="button magenta mtop10" data-action="formSubmit" data-success="Дані успішно збережено" /></td>
		        </tr>
	        </table>
		</form>
	</div>
